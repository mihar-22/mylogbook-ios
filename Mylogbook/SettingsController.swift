...
class SettingsController: UITableViewController {
    ...
    func didTapTellFriends() {
        ...
        mailer.setMessageBody("<div>Hello!</div><p>I've been using Mylogbook and thought it could help you too. It's an easy way to record your hours for your learner logbook and track your progress towards your P's.<p><a href=\"itms-apps://itunes.apple.com/app/id1229419388?mt=8\">Open in App Store</a>", isHTML: true)
